...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs} instances.
 *
 * @see org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs
 *
 */
public class NrpTerminationSpecAttrsBuilder implements Builder<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs> {
    ...
    Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs>> augmentation = Collections.emptyMap();

    public NrpTerminationSpecAttrsBuilder() {
    }
    public NrpTerminationSpecAttrsBuilder(org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.GNRPTerminationSpec arg) {
    ...
    public NrpTerminationSpecAttrsBuilder(NrpTerminationSpecAttrs base) {
        ...
        if (base instanceof NrpTerminationSpecAttrsImpl) {
            NrpTerminationSpecAttrsImpl impl = (NrpTerminationSpecAttrsImpl) base;
            if (!impl.augmentation.isEmpty()) {
                this.augmentation = new HashMap<>(impl.augmentation);
            }
        } else if (base instanceof AugmentationHolder) {
            @SuppressWarnings("unchecked")
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public NrpTerminationSpecAttrsBuilder setMaxFrameSize(final NRPNaturalNumber value) {
        this._maxFrameSize = value;
        return this;
    }
    
     
    public NrpTerminationSpecAttrsBuilder setNumberOfLinks(final NRPNaturalNumber value) {
        this._numberOfLinks = value;
        return this;
    }
    
     
    public NrpTerminationSpecAttrsBuilder setPhysicalLayer(final NRPPhysicalLayer value) {
        this._physicalLayer = value;
        return this;
    }
    
     
    public NrpTerminationSpecAttrsBuilder setPortConvsIdToAggLinkMap(final PortConvsIdToAggLinkMap value) {
        this._portConvsIdToAggLinkMap = value;
        return this;
    }
    
     
    public NrpTerminationSpecAttrsBuilder setResiliency(final NRPInterfaceResiliency value) {
        this._resiliency = value;
        return this;
    }
    
     
    public NrpTerminationSpecAttrsBuilder setServiceProviderUniId(final java.lang.String value) {
        this._serviceProviderUniId = value;
        return this;
    }
    
     
    public NrpTerminationSpecAttrsBuilder setSyncMode(final List<SyncMode> value) {
        this._syncMode = value;
        return this;
    }
    
     
    public NrpTerminationSpecAttrsBuilder setLinkOamEnabled(final java.lang.Boolean value) {
        this._linkOamEnabled = value;
        return this;
    }
    
     
    public NrpTerminationSpecAttrsBuilder setTokenShareEnabled(final java.lang.Boolean value) {
        this._tokenShareEnabled = value;
        return this;
    }
    
    public NrpTerminationSpecAttrsBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs> augmentationValue) {
    ...
    public NrpTerminationSpecAttrsBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    @Override
    public NrpTerminationSpecAttrs build() {
        return new NrpTerminationSpecAttrsImpl(this);
    }

    private static final class NrpTerminationSpecAttrsImpl implements NrpTerminationSpecAttrs {

        @Override
        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs.class;
        }
        ...
        private NrpTerminationSpecAttrsImpl(NrpTerminationSpecAttrsBuilder base) {
            this._maxFrameSize = base.getMaxFrameSize();
            this._numberOfLinks = base.getNumberOfLinks();
            this._physicalLayer = base.getPhysicalLayer();
            this._portConvsIdToAggLinkMap = base.getPortConvsIdToAggLinkMap();
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs other = (org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.network.topology.topology.node.termination.point.ltp.attrs.lplist.lpspec.terminationspec.NrpTerminationSpecAttrs)obj;
        ...
        public java.lang.String toString() {
            java.lang.String name = "NrpTerminationSpecAttrs [";
