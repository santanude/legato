 ...
 * <i>mef-nrp-specs/G_NRP_UNI_TerminationSpec/egressBwpUni</i>
 *
 * <p>To create instances of this class use {@link org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUniBuilder}.
 * @see org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUniBuilder
 *
 */
public interface EgressBwpUni
    extends
    ChildOf<GNRPUNITerminationSpec>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>,
    GNRPBwpFlow
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:mef:nrp-specs",
        "2016-06-30", "egressBwpUni").intern();
