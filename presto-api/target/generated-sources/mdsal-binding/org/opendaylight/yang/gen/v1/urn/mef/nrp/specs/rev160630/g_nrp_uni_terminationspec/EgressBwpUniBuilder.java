...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni} instances.
 *
 * @see org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni
 *
 */
public class EgressBwpUniBuilder implements Builder<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni> {
    ...
    Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>> augmentation = Collections.emptyMap();

    public EgressBwpUniBuilder() {
    }
    public EgressBwpUniBuilder(org.opendaylight.yang.gen.v1.urn.mef.nrp.bandwidth.profile.rev160630.GNRPBwpFlow arg) {
    ...
    public EgressBwpUniBuilder(EgressBwpUni base) {
        ...
        if (base instanceof EgressBwpUniImpl) {
            EgressBwpUniImpl impl = (EgressBwpUniImpl) base;
            if (!impl.augmentation.isEmpty()) {
                this.augmentation = new HashMap<>(impl.augmentation);
            }
        } else if (base instanceof AugmentationHolder) {
            @SuppressWarnings("unchecked")
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public EgressBwpUniBuilder setBwpFlowIndex(final NRPPositiveInteger value) {
        this._bwpFlowIndex = value;
        return this;
    }
    
     
    public EgressBwpUniBuilder setCbs(final NRPNaturalNumber value) {
        this._cbs = value;
        return this;
    }
    
     
    public EgressBwpUniBuilder setCir(final NRPNaturalNumber value) {
        this._cir = value;
        return this;
    }
    
     
    public EgressBwpUniBuilder setCirMax(final NRPNaturalNumber value) {
        this._cirMax = value;
        return this;
    }
    
     
    public EgressBwpUniBuilder setColorMode(final NRPColorMode value) {
        this._colorMode = value;
        return this;
    }
    
     
    public EgressBwpUniBuilder setCouplingFlag(final NRPNaturalNumber value) {
        this._couplingFlag = value;
        return this;
    }
    
     
    public EgressBwpUniBuilder setEbs(final NRPNaturalNumber value) {
        this._ebs = value;
        return this;
    }
    
     
    public EgressBwpUniBuilder setEir(final NRPNaturalNumber value) {
        this._eir = value;
        return this;
    }
    
     
    public EgressBwpUniBuilder setEirMax(final NRPNaturalNumber value) {
        this._eirMax = value;
        return this;
    }
    
     
    public EgressBwpUniBuilder setRank(final NRPPositiveInteger value) {
        this._rank = value;
        return this;
    }
    
     
    public EgressBwpUniBuilder setTokenRequestOffset(final NRPNaturalNumber value) {
        this._tokenRequestOffset = value;
        return this;
    }
    
    public EgressBwpUniBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni> augmentationValue) {
    ...
    public EgressBwpUniBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    @Override
    public EgressBwpUni build() {
        return new EgressBwpUniImpl(this);
    }

    private static final class EgressBwpUniImpl implements EgressBwpUni {

        @Override
        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>> augmentation = Collections.emptyMap();

        private EgressBwpUniImpl(EgressBwpUniBuilder base) {
            this._bwpFlowIndex = base.getBwpFlowIndex();
            this._cbs = base.getCbs();
            this._cir = base.getCir();
            this._cirMax = base.getCirMax();
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni other = (org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                EgressBwpUniImpl otherImpl = (EgressBwpUniImpl) obj;
                if (!Objects.equals(augmentation, otherImpl.augmentation)) {
                    return false;
                }
            } else {
                // Hard case: compare our augments with presence there...
                for (Map.Entry<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_uni_terminationspec.EgressBwpUni>> e : augmentation.entrySet()) {
        ...
        public java.lang.String toString() {
            java.lang.String name = "EgressBwpUni [";
