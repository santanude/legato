...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow} instances.
 *
 * @see org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow
 *
 */
public class IngressBwpFlowBuilder implements Builder<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow> {
    ...
    Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>> augmentation = Collections.emptyMap();

    public IngressBwpFlowBuilder() {
    }
    public IngressBwpFlowBuilder(org.opendaylight.yang.gen.v1.urn.mef.nrp.bandwidth.profile.rev160630.GNRPBwpFlow arg) {
    ...
    public IngressBwpFlowBuilder(IngressBwpFlow base) {
        ...
        if (base instanceof IngressBwpFlowImpl) {
            IngressBwpFlowImpl impl = (IngressBwpFlowImpl) base;
            if (!impl.augmentation.isEmpty()) {
                this.augmentation = new HashMap<>(impl.augmentation);
            }
        } else if (base instanceof AugmentationHolder) {
            @SuppressWarnings("unchecked")
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public IngressBwpFlowBuilder setBwpFlowIndex(final NRPPositiveInteger value) {
        this._bwpFlowIndex = value;
        return this;
    }
    
     
    public IngressBwpFlowBuilder setCbs(final NRPNaturalNumber value) {
        this._cbs = value;
        return this;
    }
    
     
    public IngressBwpFlowBuilder setCir(final NRPNaturalNumber value) {
        this._cir = value;
        return this;
    }
    
     
    public IngressBwpFlowBuilder setCirMax(final NRPNaturalNumber value) {
        this._cirMax = value;
        return this;
    }
    
     
    public IngressBwpFlowBuilder setColorMode(final NRPColorMode value) {
        this._colorMode = value;
        return this;
    }
    
     
    public IngressBwpFlowBuilder setCouplingFlag(final NRPNaturalNumber value) {
        this._couplingFlag = value;
        return this;
    }
    
     
    public IngressBwpFlowBuilder setEbs(final NRPNaturalNumber value) {
        this._ebs = value;
        return this;
    }
    
     
    public IngressBwpFlowBuilder setEir(final NRPNaturalNumber value) {
        this._eir = value;
        return this;
    }
    
     
    public IngressBwpFlowBuilder setEirMax(final NRPNaturalNumber value) {
        this._eirMax = value;
        return this;
    }
    
     
    public IngressBwpFlowBuilder setRank(final NRPPositiveInteger value) {
        this._rank = value;
        return this;
    }
    
     
    public IngressBwpFlowBuilder setTokenRequestOffset(final NRPNaturalNumber value) {
        this._tokenRequestOffset = value;
        return this;
    }
    
    public IngressBwpFlowBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow> augmentationValue) {
    ...
    public IngressBwpFlowBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    @Override
    public IngressBwpFlow build() {
        return new IngressBwpFlowImpl(this);
    }

    private static final class IngressBwpFlowImpl implements IngressBwpFlow {

        @Override
        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>> augmentation = Collections.emptyMap();

        private IngressBwpFlowImpl(IngressBwpFlowBuilder base) {
            this._bwpFlowIndex = base.getBwpFlowIndex();
            this._cbs = base.getCbs();
            this._cir = base.getCir();
            this._cirMax = base.getCirMax();
            ...
            case 0:
                ...
                break;
            case 1:
                final Map.Entry<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>> e = base.augmentation.entrySet().iterator().next();
                this.augmentation = Collections.<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>>singletonMap(e.getKey(), e.getValue());
                break;
            default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow other = (org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                IngressBwpFlowImpl otherImpl = (IngressBwpFlowImpl) obj;
                if (!Objects.equals(augmentation, otherImpl.augmentation)) {
                    return false;
                }
            } else {
                // Hard case: compare our augments with presence there...
                for (Map.Entry<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>>, Augmentation<org.opendaylight.yang.gen.v1.urn.mef.nrp.specs.rev160630.g_nrp_connadaptspec.IngressBwpFlow>> e : augmentation.entrySet()) {
        ...
        public java.lang.String toString() {
            java.lang.String name = "IngressBwpFlow [";
