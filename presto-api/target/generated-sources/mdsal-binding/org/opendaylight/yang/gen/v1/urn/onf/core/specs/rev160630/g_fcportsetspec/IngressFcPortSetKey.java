...
public class IngressFcPortSetKey
 implements Identifier<IngressFcPortSet> {
    private static final long serialVersionUID = -7529056435854986988L;
    private final TopologyId _topology;
    private final NodeId _node;
    private final TpId _tp;


    public IngressFcPortSetKey(NodeId _node, TopologyId _topology, TpId _tp) {
     ...
     */
    public IngressFcPortSetKey(IngressFcPortSetKey source) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        IngressFcPortSetKey other = (IngressFcPortSetKey) obj;
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.onf.core.specs.rev160630.g_fcportsetspec.IngressFcPortSetKey.class.getSimpleName()).append(" [");
        boolean first = true;
